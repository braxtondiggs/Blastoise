...
import { heroClock, heroMapPin, heroBolt } from '@ng-icons/heroicons/outline';
...
export class VisitCard {
  ...
  getLocation(): string {
    ...
    if (this.venue?.state_province) {
      parts.push(this.venue.state_province);
    }
  ...
  /**
   * Get human-readable source label with emoji
   */
